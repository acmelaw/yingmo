...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "btn-success": "btn-base bg-accent-green text-base-black",

    // Ghost button - transparent background
    "btn-ghost": "btn-base bg-transparent shadow-none",
    ...
    // Page container
    "container-page": "max-w-4xl mx-auto px-4",

    // Surface with border and shadow
    "surface-elevated": "bg-base-white border-3 border-base-black shadow-hard",
