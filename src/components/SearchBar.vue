...
<template>
  <div class="relative w-full">
    <div
      class="relative flex items-center bg-brutal-white border-3 border-brutal-black p-3 transition-all duration-200 focus-within:(border-brutal-green shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] translate-x-[-1px] translate-y-[-1px])"
    >
    ...
    >
      <div
        ...
        class="absolute top-[calc(100%+8px)] left-0 right-0 bg-brutal-white border-3 border-brutal-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] max-h-[300px] overflow-y-auto z-100"
      >
        <div
          class="px-4 py-3 pb-2 border-b-2 border-brutal-black bg-bg-secondary"
        >
        ...
        >
          ...
          <span class="flex-1 text-base font-bold text-brutal-black">{{
            tag
          }}</span>
          <span
            class="text-xs font-black px-2 py-0.5 bg-brutal-cyan border-2 border-brutal-black text-brutal-black"
          >
